   ...
   public CitacZDisku()
   {
      ...
      btnKoniec.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            ...
            setVisible(false);
            Vyhladavanie hladanie = new Vyhladavanie();
            hladanie.pracaSUctom();
         }
      });
      ...
      btnKoniec.setBounds(10, 383, 378, 51);
      panel.add(btnKoniec);
      
      JPanel panel_1 = new JPanel();
      panel_1.setBackground(Color.DARK_GRAY);
      panel_1.setBounds(0, 0, 337, 453);
