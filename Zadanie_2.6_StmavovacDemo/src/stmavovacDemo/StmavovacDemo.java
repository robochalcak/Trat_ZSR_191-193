...
public class StmavovacDemo
{
    public static void main(String[] args)  // main method definition
    {
        ...
        System.out.println("=====================================");
        System.out.println("The color is to bright, so I am going");
        System.out.println("to make it 2x times darker with method darker()");
        System.out.println("Done first time, new values below...");

        color = color.darker();  // calling method to make the color darker first time
        ...
        color = color.darker();  // calling method again to make the color more darker.
