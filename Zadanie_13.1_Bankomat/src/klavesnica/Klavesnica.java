...
public class Klavesnica
{
    ...
    private void initialize()
    {
        ...
        btn0.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                vstup.setText(vstup.getText()+"0");
            }
        });
        btnBodka = new JButton(".");
        btnBodka.addActionListener(new ActionListener()
        {
            @Override
            public void actionPerformed(ActionEvent e)
            {
                vstup.setText(vstup.getText()+".");
            }
        });
        ...
        instrukcie.setText("Zadaj klientske cislo: \n A = OK");
    ...
    public void setKlientskeCislo(String cislo)
    {
        this.klientskeCislo=Integer.parseInt(cislo);
    }

    public void setInstrukcie(String sprava)
    {
         instrukcie.setText(sprava);
    }
