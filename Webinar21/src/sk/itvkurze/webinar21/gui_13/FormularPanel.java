...
public class FormularPanel extends JPanel
{
   ...
   public FormularPanel()
   {
     ...
     // setBorder(BorderFactory.createLineBorder(Color.DARK_GRAY));
      ...
      lstVekoveKategorie =new JList<String>();
      
      DefaultListModel<String> vekoveKategorieModel = new DefaultListModel<String>();
      
      vekoveKategorieModel.addElement("menej ako 18 rokov");
      vekoveKategorieModel.addElement("od 18 do 60 rokov");
      vekoveKategorieModel.addElement("viac ako 60 rokov");
