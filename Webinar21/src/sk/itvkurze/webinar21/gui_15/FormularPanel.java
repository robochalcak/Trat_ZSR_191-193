...
public class FormularPanel extends JPanel
{
   ...
   private JComboBox<String>cmbStatusZamestnanca;
   ...
   public FormularPanel()
   {
     ...
     // setBorder(BorderFactory.createLineBorder(Color.DARK_GRAY));
      ...
      cmbStatusZamestnanca = new JComboBox<String>();
      
      DefaultComboBoxModel<String>modelStatusuZamestnanca = new DefaultComboBoxModel<String>();
      
      modelStatusuZamestnanca.addElement("zamestnany na TPP");
      modelStatusuZamestnanca.addElement("nezamestnany");
      modelStatusuZamestnanca.addElement("Zamestnany nan zivnost");
      
      cmbStatusZamestnanca.setModel(modelStatusuZamestnanca);
      cmbStatusZamestnanca.setSelectedIndex(0);
      ...
      btnOK.addActionListener(new ActionListener()
      {
         ...
         public void actionPerformed(ActionEvent arg0)
         {
            ...
            int id = zvolenaVekovaKategoria.getId();
            String statusZamestnanca=(String) cmbStatusZamestnanca.getSelectedItem();
            
            FormularEvent event = new FormularEvent(this,meno, zamestnanie, zvolenaVekovaKategoria.getId(),statusZamestnanca);
...
/*STVRTY RIADOK */      
       ...
       add(new JLabel("Status zamestnanca: "),gc);
