...
public class Osoba implements Serializable
{
	...
	public Osoba(int id, String meno, String zamestnanie, VekovaKategoria vekovaKategoria, ZamestnaneckyStatus status,
			boolean jeCudzinec, String statnaPrislusnost, Pohlavie pohlavie)
	{
		this(meno, zamestnanie, vekovaKategoria, status, jeCudzinec, statnaPrislusnost, pohlavie);
		this.id = id;
	}
	...
	{
		return "Osoba [id=" + id + ", meno=" + meno + ", zamestnanie=" + zamestnanie + ", vekovaKategoria="
				+ vekovaKategoria + ", status=" + status + ", jeCudzinec=" + jeCudzinec + ", statnaPrislusnost="
				+ statnaPrislusnost + ", pohlavie=" + pohlavie + "]";
	}
