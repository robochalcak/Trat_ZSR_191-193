...
public class MainMetoda
{
   ...
   public static void zobrazHlavneMenu(Klienti klienti, BankoveUcty ucty,
         Scanner kb) throws FileNotFoundException, ClassNotFoundException, IOException
   {
    ...
    * @throws ClassNotFoundException 
    */
   public static void vytvorVklad(Klienti klienti, BankoveUcty ucty, Scanner kb) throws ClassNotFoundException, IOException
   {
      ...
      zmena = ucty.vyhladajUcet(klienti.vyhladajKlienta(priezvisko, rc)
            .getRovnakeId());
      if(zmena.getTypUctu().equalsIgnoreCase("bežný"))
      {
         zmena.vloz(vklad);
         zmena.pripisUrok();
         ucty.urobZmenuNaBeznomUcte(zmena, index);
      }
      else
      {
         zmena.vloz(vklad);
         zmena.pripisUrok();
         ucty.urobZmenuNaSporiacomUcte(zmena, index);
      }
    ...
    * @throws ClassNotFoundException 
    */
   public static void vytvorVyber(Klienti klienti, BankoveUcty ucty, Scanner kb) throws ClassNotFoundException, IOException
   {
   ...
   public static void vstupDoSystemu(Klienti klienti, BankoveUcty ucty,Scanner kb) throws FileNotFoundException, ClassNotFoundException, IOException
   {
      String moznost;
      do
      {
   ...
   public static void prihlasenieSa(Klienti klienti, BankoveUcty ucty,Scanner kb) throws FileNotFoundException, ClassNotFoundException, IOException
   {
      String meno;
      String id;
   ...
   public static void registracia(Scanner kb) throws FileNotFoundException, ClassNotFoundException, IOException
   {
      Zamestnanci zamestnanci = new Zamestnanci();
      ...
      System.out.println("Prihlasit sa mozete pomocou vaseho mena: "+((Zamestnanec) zamestnanec).getMeno());
      System.out.println("alebo vaseho prideleneho ID, ktore si zapiste: "+((Zamestnanec)zamestnanec).getId());
      return;
