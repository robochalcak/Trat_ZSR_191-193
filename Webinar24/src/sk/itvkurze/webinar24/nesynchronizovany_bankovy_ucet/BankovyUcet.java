...
public class BankovyUcet
{
   ...
   public synchronized void vloz2(double ciastka)
   {
         System.out.println("Vklad "+ciastka+ " Eur.");
         double novyZostatok = aktualnyZostatok + ciastka;
         System.out.println(", novy zostatok je "+novyZostatok + " Eur.");
   ...
   public synchronized void vyber2(double ciastka)
   {
   ...
   public synchronized void vloz3(double ciastka)
   {
         System.out.println("Vklad "+ciastka+ " Eur.");
         double novyZostatok = aktualnyZostatok + ciastka;
         System.out.println(", novy zostatok je "+novyZostatok + " Eur.");
         
         synchronized (dostatokProstriedkovNaUcte)
         {
            this.aktualnyZostatok +=ciastka;
         }     
   }

   public synchronized void vyber3(double ciastka)
   {
