...
public class BankovyUcetTester
{
   ...
   public static void main(String[] args)
   {
      ...
      {
         Vklad vklad = new Vklad(ucet, ciastka,POCET_OPAKOVANI);
         Vyber vyber = new Vyber(ucet, ciastka, POCET_OPAKOVANI);
         
         Thread vlaknoPreVklad = new Thread(vklad);
         Thread vlaknoPreVyber = new Thread(vyber);
         
         vlaknoPreVklad.start();
         vlaknoPreVyber.start();
      }
