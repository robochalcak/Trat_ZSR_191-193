...
public class ZretazenyZoznamTester
{
   ...
   {
      ZretazenyZoznam<String> studenti = new ZretazenyZoznam<String>();
      ...
      ZoznamIterator<String> iterator = studenti.iteratorZoznamu();
   ...
   {
      ZoznamIterator<String> iterator = zoznam.iteratorZoznamu();
      while(iterator.existujeDalsiPrvok())
      {
